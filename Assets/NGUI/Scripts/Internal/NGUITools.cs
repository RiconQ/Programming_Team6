...
#if UNITY_5_5_OR_NEWER
		UnityEngine.Profiling.Profiler.BeginSample("Editor-only GC allocation (GetComponent)");
		var comp = go.GetComponentInParent<T>(true);
		//var comp = go.GetComponentInParent<T>(); 2024/01/03 꺼진 부모 오브젝트도 찾을 수 있게 변경
		UnityEngine.Profiling.Profiler.EndSample();
#else
		Profiler.BeginSample("Editor-only GC allocation (GetComponent)");
...
#if UNITY_5_5_OR_NEWER
		UnityEngine.Profiling.Profiler.BeginSample("Editor-only GC allocation (GetComponent)");
		var comp = trans.GetComponentInParent<T>(true);
		//var comp = trans.GetComponentInParent<T>(); 2024/01/03 꺼진 부모 오브젝트도 찾을 수 있게 변경
		UnityEngine.Profiling.Profiler.EndSample();
#else
		Profiler.BeginSample("Editor-only GC allocation (GetComponent)");
